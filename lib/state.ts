...
import { Agent, Rachel, Cody, Tara, Alex, DrP, Casey, Mike, Edu, Emma, Welcome } from './presets/agents';
...
export const useAgent = create<{
  ...
  current: Welcome,
  availablePresets: [Welcome, Rachel, Cody, Tara, Alex, DrP, Casey, Mike, Edu, Emma],
  availablePersonal: [],
